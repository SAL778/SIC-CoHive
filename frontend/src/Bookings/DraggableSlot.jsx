...
const DraggableSlot = ({
	...
	useEffect(() => {
		document.addEventListener("mouseup", handleMouseUp); //global mouseup listener
		return () => {
			document.removeEventListener("mouseup", handleMouseUp); //cleanup
		};
	}, [selectedSlot, onRelease, resourceName]);
