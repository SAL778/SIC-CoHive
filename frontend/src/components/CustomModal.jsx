    ...
    return (
        <Modal {...props} className = "h-fit w-fit absolute left-1/2 top-1/2 p-8">
            ...
            <div className = "buttonFooter flex justify-end gap-3 mt-4">
                <button type="button" onClick = {onNegative} className = "text-neutral-500 hover:text-neutral-600 text-base p-3">
                    {props.negativeText ?? "Cancel"}
                </button>
                <button type="button" onClick = {onAffirmative} className = "text-white bg-orange-600 rounded-md hover:bg-orange-700 text-base p-3">
