...
function PortfolioCard({
	...
	return (
		//Card container
		<div className="portfolio-card p-5 m-5 rounded-[12px] h-64 w-56 flex flex-col place-content-between ease-out duration-200 shadow-custom hover:cursor-pointer">
