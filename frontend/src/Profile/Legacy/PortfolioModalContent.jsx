...
export function PortfolioItemEdit({
	onEditSubmit,
	onEditCancel,
	portfolioItem,
}) {
	...
	return (
		<form
			...
			className="flex flex-col gap-[20px] w-[600px]"
		>
			<input
				type="text"
				name="title"
			...
			<div className="flex flex-row justify-end mt-[32px] gap-[20px]">
				<button
					...
					className="cancelDeleteItem bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded"
				>
					Cancel
				</button>
				<button
					type="submit"
					className="submitDeleteItem bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
				>
					Submit
				</button>
			</div>
...
export function PortfolioItemDelete({
	onDeleteSubmit,
	onDeleteCancel,
	portfolioItem,
}) {
